...
from .models import Catagory,page
...
def catagory(request, catagory_name_slug):
    ...
    try:
        ...
        context_dict['catagory_name'] = catagory.name
        ...
        context_dict['catagory_name_slug'] = catagory_name_slug
...
def add_catagory(request):
    ...
    return render(request, 'rango/add_catagory.html', {'form': form})

def add_page(request, catagory_name_slug):

    try:
        cat = Catagory.objects.get(slug=catagory_name_slug)
    except Catagory.DoesNotExist:
                cat = None
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            if cat:
                ...
                return catagory(request,catagory_name_slug)
        else:
            print (form.errors)
    else:
        form = PageForm()

    context_dict = {'form':form, 'catagory': cat, 'catagory_name_slug':catagory_name_slug}
